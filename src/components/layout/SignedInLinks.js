  ...
  return (
    ...
    <div>
        ...
        <li>
            <div className="user-view">
                <a href="/profile"><img className="circle avatar" src="img/userpic.jpg" alt="profile_photo" /></a>
                <a href="/"><span className="white-text name center-align">{this.props.profile.firstName} {this.props.profile.lastName}</span></a>
                <a href="/"><span className="white-text email center-align">{this.props.auth.email}</span></a>
            </div>
        </li>
    ...
    <nav className=" light-blue lighten-2 hide-on-large-only">
                <div className="nav-wrapper ">
                  <a href="/" className="brand-logo right">K3MP&nbsp;&nbsp;</a>
